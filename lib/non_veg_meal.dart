...
class NonVegMeal extends StatefulWidget{
  @override
  State<NonVegMeal> createState() => _NonVegMealState();
}

class _NonVegMealState extends State<NonVegMeal> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Non Veg Meal', style: TextStyle(color: Colors.white, fontSize: 18),),
      ),
                    ...
                    child: Card(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text('Roti, Rice, Non-Veg Curry, Dal, Salad, Pickle', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w800),),
                          ),
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Row(
                    ...
                    child: Card(
                      child: Padding(
                        ...
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Today's Curry", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),),
                            SizedBox(height: 11,),
                            ListTile(
                              title: Text('Chicken Curry', style: TextStyle(fontWeight: FontWeight.w700),),
                            ),
                          ],
                        ),
                      ),
